# brand-erria-4a9f1e implementation handoff

This archive is the source of truth for turning the design into production code. Start from `brand.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `brand.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `brand.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `assets/erria-favicon-192.png`
- `assets/erria-logo.png`
- `context/input-DESIGN.md`
- `context/source-context.md`
- `DESIGN.md`

## Coding checklist for AI tools
1. Inspect `brand.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
